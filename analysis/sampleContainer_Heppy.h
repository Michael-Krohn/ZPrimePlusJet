...
// Wed Apr 19 22:31:42 2017 by ROOT version 6.06/01
// from TTree otree/Events
// found on file: eos/cms/store/group/phys_exotica/dijet/dazsle/zprimebits-v12.05/sklim2/JetHTRun2016G_03Feb2017_v1_v3.root
//////////////////////////////////////////////////////////

#ifndef sampleContainer_Heppy_h
#define sampleContainer_Heppy_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   sampleContainer_Heppy(TTree *tree=0);
   virtual ~sampleContainer_Heppy();
        # define histograms
        # define histograms
...
#ifdef sampleContainer_Heppy_cxx
sampleContainer_Heppy::sampleContainer_Heppy(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("eos/cms/store/group/phys_exotica/dijet/dazsle/zprimebits-v12.05/sklim2/JetHTRun2016G_03Feb2017_v1_v3.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("eos/cms/store/group/phys_exotica/dijet/dazsle/zprimebits-v12.05/sklim2/JetHTRun2016G_03Feb2017_v1_v3.root");
      }
...
sampleContainer_Heppy::~sampleContainer_Heppy()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t sampleContainer_Heppy::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t sampleContainer_Heppy::LoadTree(Long64_t entry)
{
...
void sampleContainer_Heppy::Init(TTree *tree)
{
...
Bool_t sampleContainer_Heppy::Notify()
{
...
void sampleContainer_Heppy::Show(Long64_t entry)
{
...
Int_t sampleContainer_Heppy::Cut(Long64_t entry)
{
...
#endif // #ifdef sampleContainer_cxx
