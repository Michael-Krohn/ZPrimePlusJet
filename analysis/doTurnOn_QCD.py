...
functionMin = 300#100
functionMax = 400#200
var             = "AK8PFJetsMatchedToCaloJets300_pt[0]"
#var             = "Jet_pt[1]+Jet_pt[2]+Jet_pt[3]"
trigger         = "(l1Jets_pt[0]>170 && AK8CaloJetsIDPassed_pt[0]>300 && abs(AK8CaloJetsIDPassed_eta[0])<5.0)"
