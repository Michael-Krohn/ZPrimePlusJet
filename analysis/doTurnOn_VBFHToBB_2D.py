...
#    addInfo.AddText("p_{T} > 400 GeV,")
    addInfo.AddText("p_{T,1} > 92 GeV, p_{T,2} > 76 GeV")
    addInfo.AddText("p_{T,3} > 64 GeV, p_{T,4} > 30 GeV")
    addInfo.AddText("|#eta| < 4.7")
    addInfo.Draw("same")
...
preselection = "pfJets_pt[0]>92 && pfJets_pt[1]>76 && pfJets_pt[2]>64 && pfJets_pt[3]>15 && abs(pfJets_eta[0])<4.7 && abs(pfJets_eta[1])<4.7 && abs(pfJets_eta[2])<4.7 && abs(pfJets_eta[3])<4.7"
...
Nbins       = 5#50 
functionMin = 240#100
functionMax = 3500#200
NbinsY      = 5
yMin        = 0.5
yMax        = 1.
var             = "Mqq_2b_offline[0]"
var2            = "HighestOffJetForBTag_csv[0]"
#var             = "Mqq_2b[0]"
#var2            = "Dphibb_2b[0]"
#trigger         = "caloJets_num[0] > 3 && caloJets_pt[0]>80 && caloJets_pt[1]>65 && caloJets_pt[2]>50 && caloJets_pt[3]>15 && HighestAK8CaloJetForBTag_csv[0]>0.8 && pfJets_num[0]>3 && pfJets_pt[0]>92 && pfJets_pt[1]>76 && pfJets_pt[2]>64 && pfJets_pt[3]>15 && Detaqq_eta[0] > 1.5 && Mqq_eta[0] > 150 && HighestPFJetForBTag_csv[0]>0.82 && Detaqq_1b[0]>4.1 && Mqq_1b[0]>500 && Dphibb_1b[0]<1.6"
trigger         = "caloJets_num[0] > 3 && caloJets_pt[0]>80 && caloJets_pt[1]>65 && caloJets_pt[2]>50 && caloJets_pt[3]>15 && HighestAK8CaloJetForBTag_csv[0]>0.8 && pfJets_num[0]>3 && pfJets_pt[0]>92 && pfJets_pt[1]>76 && pfJets_pt[2]>64 && pfJets_pt[3]>15 && Detaqq_eta[0] > 1.5 && Mqq_eta[0] > 150 && HighestPFJetForBTag_csv[0]>0.82 && HighestPFJetForBTag_csv[1]>0.47 && Detaqq_2b[0]>2.3 && Mqq_2b[0]>240 && Dphibb_2b[0]<2.1"
binning         = (NbinsY,yMin,yMax,Nbins,functionMin,functionMax)
ped             = "VBF_Trig"
ytitle          = "M_{qq} (GeV)"
xtitle		= "Highest AK4 Jet CSV"
doPlots()
