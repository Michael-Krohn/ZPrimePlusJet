import ROOT
from ROOT import TFile, TTree, TChain, gPad, gDirectory, TLorentzVector
...
def getDeltaEta(self, AK4ref_1, AK4ref_2):
	DEta = -999.
	if (AK4ref_1 == 0 and AK4ref_2 == 1) or (AK4ref_1 == 1 and AK4ref_2 == 0):
		DEta = abs(self.AK4Puppijet0_eta[0] - self.AK4Puppijet1_eta[0])
        if (AK4ref_1 == 0 and AK4ref_2 == 2) or (AK4ref_1 == 2 and AK4ref_2 == 0):
...
def getMjj(self, AK4ref_1, AK4ref_2):
	mjj = -999.
	...
	if (AK4ref_1 == 1 and AK4ref_2 == 2) or (AK4ref_1 == 2 and AK4ref_2 == 1):
                ...
                AK4_1.SetPtEtaPhiM(self.AK4Puppijet2_pt[0],self.AK4Puppijet2_eta[0],self.AK4Puppijet2_phi[0],self.AK4Puppijet2_mass[0])
                mjj = (AK4_0 + AK4_1).M()
        if (AK4ref_1 == 1 and AK4ref_2 == 3) or (AK4ref_1 == 3 and AK4ref_2 == 1):
                AK4_0.SetPtEtaPhiM(self.AK4Puppijet1_pt[0],self.AK4Puppijet1_eta[0],self.AK4Puppijet1_phi[0],self.AK4Puppijet1_mass[0])
                AK4_1.SetPtEtaPhiM(self.AK4Puppijet3_pt[0],self.AK4Puppijet3_eta[0],self.AK4Puppijet3_phi[0],self.AK4Puppijet3_mass[0])
                mjj = (AK4_0 + AK4_1).M()
...
class sampleContainer_Heppy:
    def __init__(self, name, fn, sf=1, DBTAGCUTMIN=-99., lumi=1, isData=False, fillCA15=False, cutFormula='1',
        ...
        f_pu = ROOT.TFile.Open("/uscms_data/d3/mkrohn/DAZSLE/ggH_Analyzer/CMSSW_8_0_12/src/ZPrimePlusJet/analysis/ggH/puWeights_All.root", "read")
        self._puw = f_pu.Get("puw")
        self._puw_up = f_pu.Get("puw_p")
        self._puw_down = f_pu.Get("puw_m")

        # get histogram for transform
        f_h2ddt = ROOT.TFile.Open("/uscms_data/d3/mkrohn/DAZSLE/ggH_Analyzer/CMSSW_8_0_12/src/ZPrimePlusJet/analysis/ZqqJet/h3_n2ddt_26eff_36binrho11pt_Spring16.root",
        ...
        f_trig = ROOT.TFile.Open(
            "/uscms_data/d3/mkrohn/DAZSLE/ggH_Analyzer/CMSSW_8_0_12/src/ZPrimePlusJet/analysis/ggH/RUNTriggerEfficiencies_SingleMuon_Run2016_V2p1_v03.root", "read")
        ...
        f_mutrig_GH = ROOT.TFile.Open("/uscms_data/d3/mkrohn/DAZSLE/ggH_Analyzer/CMSSW_8_0_12/src/ZPrimePlusJet/analysis/ggH/EfficienciesAndSF_Period4.root", "read")
        ...
        f_mutrig_BCDEF = ROOT.TFile.Open("/uscms_data/d3/mkrohn/DAZSLE/ggH_Analyzer/CMSSW_8_0_12/src/ZPrimePlusJet/analysis/ggH/EfficienciesAndSF_RunBtoF.root", "read")
        ...
        f_muid_GH = ROOT.TFile.Open("/uscms_data/d3/mkrohn/DAZSLE/ggH_Analyzer/CMSSW_8_0_12/src/ZPrimePlusJet/analysis/ggH/EfficienciesAndSF_GH.root", "read")
        ...
        f_muid_BCDEF = ROOT.TFile.Open("/uscms_data/d3/mkrohn/DAZSLE/ggH_Analyzer/CMSSW_8_0_12/src/ZPrimePlusJet/analysis/ggH/EfficienciesAndSF_BCDEF.root", "read")
        ...
        f_muiso_GH = ROOT.TFile.Open("/uscms_data/d3/mkrohn/DAZSLE/ggH_Analyzer/CMSSW_8_0_12/src/ZPrimePlusJet/analysis/ggH/EfficienciesAndSF_ISO_GH.root", "read")
        ...
        f_muiso_BCDEF = ROOT.TFile.Open("/uscms_data/d3/mkrohn/DAZSLE/ggH_Analyzer/CMSSW_8_0_12/src/ZPrimePlusJet/analysis/ggH/EfficienciesAndSF_ISO_BCDEF.root", "read")
        ...
        if not self._minBranches:
            histos1d_ext = {
                ...
                'h_met_dbtagCut': ["h_" + self._name + "_met_dbtagCut", "; E_{T}^{miss} (GeV) ;", 25, 0, 140],
                ...
                'h_DeltaR_0': ["h_" + self._name + "_DeltaR_0", "; #DeltaR(AK8_{1},AK4_{1});", 40, 0,3.2],
                'h_DeltaR_1': ["h_" + self._name + "_DeltaR_1", "; #DeltaR(AK8_{1},AK4_{2});", 40, 0,3.2],
                'h_DeltaR_Higgs_AK8': ["h_" + self._name + "_DeltaR_Higgs_AK8", "; #DeltaR(AK8_{1},Higgs);", 40, 0,3.2],
                'h_mjj_ak4': ["h_" + self._name + "_mjj_ak4", "; m_{jj} GeV;", 23, 0,500],
                'h_ak4_multiplicity_pT30': ["h_" + self._name + "_ak4_multiplicity_pT30", "; AK4 jets;", 5, 0,5],
                'h_ak4_multiplicity_pT50': ["h_" + self._name + "_ak4_multiplicity_pT50", "; AK4 jets;", 5, 0,5],
                'h_ak4_multiplicity_pT70': ["h_" + self._name + "_ak4_multiplicity_pT70", "; AK4 jets;", 5, 0,5],
                ...
                'h_dEta_ak4_nonH_dbtagCut': ["h_" + self._name + "_dEta_ak4_nonH_dbtagCut", "; #Delta#eta(AK4_{q1},AK4_{q2});", 23, -2,6.4],
                'h_dEta_ak4_nonH_dbtagCut_pT30': ["h_" + self._name + "_dEta_ak4_nonH_dbtagCut_pT30", "; #Delta#eta(AK4_{q1},AK4_{q2});", 23, -2,6.4],
                'h_dEta_ak4_nonH_dbtagCut_pT50': ["h_" + self._name + "_dEta_ak4_nonH_dbtagCut_pT50", "; #Delta#eta(AK4_{q1},AK4_{q2});", 23, -2,6.4],
                'h_dEta_ak4_nonH_dbtagCut_pT70': ["h_" + self._name + "_dEta_ak4_nonH_dbtagCut_pT70", "; #Delta#eta(AK4_{q1},AK4_{q2});", 23, -2,6.4],
                'h_dEta_ak4_nonH_dbtagCut_pT100': ["h_" + self._name + "_dEta_ak4_nonH_dbtagCut_pT100", "; #Delta#eta(AK4_{q1},AK4_{q2});", 23, -2,6.4],
                'h_dEta_ak4_dbtagCut': ["h_" + self._name + "_dEta_ak4_dbtagCut", "; #Delta#eta(AK4_{1},AK4_{2});", 23, 0,6.4],
                'h_msd_ak8_dbtagCut_Cuts': ["h_" + self._name + "_msd_ak8_dbtagCut_Cuts", "; AK8 m_{SD}^{PUPPI} (GeV);", 23, 40,201],
                ...
                'h_n2b1sd_ak8': ["h_" + self._name + "_n2b1sd_ak8", "; AK8 N_{2}^{1} (SD);", 25, -0.2, 0.8],
...
#            jtN2b1sd_8 = self.AK8Puppijet0_N2sdb1[0]
	    ...
	    Lowest_DeltaR = 100.
	    Lowest2nd_DeltaR = 100.
            Lowest_DeltaR_jet = 100.
            Lowest2nd_DeltaR_jet = 100.

	    AK4jetMultiplicity_30 = 0.
            AK4jetMultiplicity_50 = 0.
            AK4jetMultiplicity_70 = 0.
            AK4jetMultiplicity_100 = 0.
	    AK4ForwardJet1_pT30 = -1.
            AK4ForwardJet2_pT30 = -1.
            AK4ForwardJet1_pT50 = -1.
            AK4ForwardJet2_pT50 = -1.
            AK4ForwardJet1_pT70 = -1.
            AK4ForwardJet2_pT70 = -1.
            AK4ForwardJet1_pT100 = -1.
            AK4ForwardJet2_pT100 = -1.

	    if self.AK4Puppijet0_pt[0] > 30. and  abs(self.AK4Puppijet0_eta[0]) > 2.5:
		AK4jetMultiplicity_30 += 1
		AK4ForwardJet1_pT30 = 0
            if self.AK4Puppijet1_pt[0] > 30. and  abs(self.AK4Puppijet1_eta[0]) > 2.5:
		if AK4jetMultiplicity_30 == 1:
			AK4ForwardJet2_pT30 = 1
		else:
			AK4ForwardJet1_pT30 = 1
                AK4jetMultiplicity_30 += 1
            if self.AK4Puppijet2_pt[0] > 30. and  abs(self.AK4Puppijet2_eta[0]) > 2.5:
                if AK4jetMultiplicity_30 == 1:
                        AK4ForwardJet2_pT30 = 2
                else:
                        AK4ForwardJet1_pT30 = 2
                AK4jetMultiplicity_30 += 1
            if self.AK4Puppijet3_pt[0] > 30. and  abs(self.AK4Puppijet3_eta[0]) > 2.5:
                if AK4jetMultiplicity_30 == 1:
                        AK4ForwardJet2_pT30 = 3
                else:
            ...
            if self.AK4Puppijet0_pt[0] > 50. and  abs(self.AK4Puppijet0_eta[0]) > 2.5:
                ...
                AK4ForwardJet1_pT50 = 0
            if self.AK4Puppijet1_pt[0] > 50. and  abs(self.AK4Puppijet1_eta[0]) > 2.5:
                if AK4jetMultiplicity_50 == 1:
                        AK4ForwardJet2_pT50 = 1
                else:
                        AK4ForwardJet1_pT50 = 1
                AK4jetMultiplicity_50 += 1
            if self.AK4Puppijet2_pt[0] > 50. and  abs(self.AK4Puppijet2_eta[0]) > 2.5:
                if AK4jetMultiplicity_50 == 1:
                        AK4ForwardJet2_pT50 = 2
                else:
                        AK4ForwardJet1_pT50 = 2
                AK4jetMultiplicity_50 += 1
            if self.AK4Puppijet3_pt[0] > 50. and  abs(self.AK4Puppijet3_eta[0]) > 2.5:
                if AK4jetMultiplicity_50 == 1:
            ...
            if self.AK4Puppijet0_pt[0] > 70. and  abs(self.AK4Puppijet0_eta[0]) > 2.5:
                ...
                AK4ForwardJet1_pT70 = 0
            if self.AK4Puppijet1_pt[0] > 70. and  abs(self.AK4Puppijet1_eta[0]) > 2.5:
                if AK4jetMultiplicity_70 == 1:
                        AK4ForwardJet2_pT70 = 1
                else:
                        AK4ForwardJet1_pT70 = 1
                AK4jetMultiplicity_70 += 1
            if self.AK4Puppijet2_pt[0] > 70. and  abs(self.AK4Puppijet2_eta[0]) > 2.5:
                if AK4jetMultiplicity_70 == 1:
                        AK4ForwardJet2_pT70 = 2
                else:
                        AK4ForwardJet1_pT70 = 2
                AK4jetMultiplicity_70 += 1
            if self.AK4Puppijet3_pt[0] > 70. and  abs(self.AK4Puppijet3_eta[0]) > 2.5:
                if AK4jetMultiplicity_70 == 1:
                        AK4ForwardJet2_pT70 = 3
                else:
            ...
            if self.AK4Puppijet0_pt[0] > 100. and  abs(self.AK4Puppijet0_eta[0]) > 2.5:
                ...
                AK4ForwardJet1_pT100 = 0
            if self.AK4Puppijet1_pt[0] > 100. and  abs(self.AK4Puppijet1_eta[0]) > 2.5:
                if AK4jetMultiplicity_100 == 1:
                        AK4ForwardJet2_pT100 = 1
                else:
                        AK4ForwardJet1_pT100 = 1
                AK4jetMultiplicity_100 += 1
            if self.AK4Puppijet2_pt[0] > 100. and  abs(self.AK4Puppijet2_eta[0]) > 2.5:
                if AK4jetMultiplicity_100 == 1:
                        AK4ForwardJet2_pT100 = 2
                else:
                        AK4ForwardJet1_pT100 = 2
                AK4jetMultiplicity_100 += 1
            if self.AK4Puppijet3_pt[0] > 100. and  abs(self.AK4Puppijet3_eta[0]) > 2.5:
                if AK4jetMultiplicity_100 == 1:
                        AK4ForwardJet2_pT100 = 3
                else:
...
#		print AK4ForwardJet2_pT30
		...
		if AK4ForwardJet1_pT30 == 0 and AK4ForwardJet2_pT30 == 1:
			...
			mjj_AK4_qq_pT30 = getMjj(self,0,1)
                if AK4ForwardJet1_pT30 == 0 and AK4ForwardJet2_pT30 == 2:
                        jDeta_ak4_pT30 = getDeltaEta(self,0,2)
                        mjj_AK4_qq_pT30 = getMjj(self,0,2)
            ...
            if AK4jetMultiplicity_50 == 2:
                if AK4ForwardJet1_pT50 == 0 and AK4ForwardJet2_pT50 == 1:
                        ...
                        mjj_AK4_qq_pT50 = getMjj(self,0,1)
                if AK4ForwardJet1_pT50 == 0 and AK4ForwardJet2_pT50 == 2:
                        jDeta_ak4_pT50 = getDeltaEta(self,0,2)
                        mjj_AK4_qq_pT50 = getMjj(self,0,2)
            ...
            if AK4jetMultiplicity_70 == 2:
                if AK4ForwardJet1_pT70 == 0 and AK4ForwardJet2_pT70 == 1:
                        ...
                        mjj_AK4_qq_pT70 = getMjj(self,0,1)
                if AK4ForwardJet1_pT70 == 0 and AK4ForwardJet2_pT70 == 2:
                        jDeta_ak4_pT70 = getDeltaEta(self,0,2)
                        mjj_AK4_qq_pT70 = getMjj(self,0,2)
            ...
            if AK4jetMultiplicity_100 == 2:
                if AK4ForwardJet1_pT100 == 0 and AK4ForwardJet2_pT100 == 1:
                        ...
                        mjj_AK4_qq_pT100 = getMjj(self,0,1)
                if AK4ForwardJet1_pT100 == 0 and AK4ForwardJet2_pT100 == 2:
                        jDeta_ak4_pT100 = getDeltaEta(self,0,2)
                        mjj_AK4_qq_pT100 = getMjj(self,0,2)
...
#		print mjj_AK4_qq_pT30
		...
		Lowest_DeltaR = DeltaR_0
		Lowest_DeltaR_jet = 0
	    if self.nAK4PuppijetsPt30[0] > 1:
		if DeltaR_1 < Lowest_DeltaR:
			Lowest2nd_DeltaR = Lowest_DeltaR
			Lowest_DeltaR = DeltaR_1
			Lowest_DeltaR_jet = 1.
			Lowest2nd_DeltaR_jet = 0.
		else:
			Lowest2nd_DeltaR = DeltaR_1
			Lowest2nd_DeltaR_jet = 1.
	    if self.nAK4PuppijetsPt30[0] > 2:
		if DeltaR_2 < Lowest2nd_DeltaR:
			if DeltaR_2 < Lowest_DeltaR:
	                        Lowest2nd_DeltaR = Lowest_DeltaR
        	                Lowest_DeltaR = DeltaR_2
                	        Lowest_DeltaR_jet = 2.
	                else:
        	                Lowest2nd_DeltaR = DeltaR_2
                	        Lowest2nd_DeltaR_jet = 2.
            if self.nAK4PuppijetsPt30[0] > 3:
                if DeltaR_3 < Lowest2nd_DeltaR:
                        if DeltaR_3 < Lowest_DeltaR:
                                Lowest2nd_DeltaR = Lowest_DeltaR
                                Lowest_DeltaR = DeltaR_3
                                Lowest_DeltaR_jet = 3.
                        else:
                                Lowest2nd_DeltaR = DeltaR_3
                                Lowest2nd_DeltaR_jet = 3.
...
#            mjj_AK4_qq = -99.
#            if self.nAK4PuppijetsPt30[0] > 2:
#		if Lowest_DeltaR > 0.8:
#			jDeta_4_nonHiggs = getDeltaEta(self, Lowest_DeltaR_jet, Lowest2nd_DeltaR_jet)
#			mjj_AK4_qq = getMjj(self, Lowest_DeltaR_jet, Lowest2nd_DeltaR_jet)
#		elif Lowest_DeltaR < 0.8:
#			if Lowest2nd_DeltaR > 0.8:
#				if (Lowest_DeltaR_jet == 0 and Lowest2nd_DeltaR_jet == 1) or (Lowest_DeltaR_jet == 1 and Lowest2nd_DeltaR_jet == 0):
#					jDeta_4_nonHiggs = getDeltaEta(self,2, Lowest2nd_DeltaR_jet)
#					mjj_AK4_qq = getMjj(self,2, Lowest2nd_DeltaR_jet)
#				if (Lowest_DeltaR_jet == 0 and Lowest2nd_DeltaR_jet == 2) or (Lowest_DeltaR_jet == 2 and Lowest2nd_DeltaR_jet == 0):
#                                        jDeta_4_nonHiggs = getDeltaEta(self,1, Lowest2nd_DeltaR_jet)
#					mjj_AK4_qq = getMjj(self,1, Lowest2nd_DeltaR_jet)
#				if (Lowest_DeltaR_jet == 1 and Lowest2nd_DeltaR_jet == 2) or (Lowest_DeltaR_jet == 2 and Lowest2nd_DeltaR_jet == 1):
#                                        jDeta_4_nonHiggs = getDeltaEta(self,0, Lowest2nd_DeltaR_jet)
#					mjj_AK4_qq = getMjj(self,0, Lowest2nd_DeltaR_jet)
#	    if self.nAK4PuppijetsPt30[0] > 3:
#                if Lowest_DeltaR > 0.8:
#                        jDeta_4_nonHiggs = getDeltaEta(self,Lowest_DeltaR_jet, Lowest2nd_DeltaR_jet)
#			mjj_AK4_qq = getMjj(self,Lowest_DeltaR_jet, Lowest2nd_DeltaR_jet)
#                elif Lowest_DeltaR < 0.8:
#                        if Lowest2nd_DeltaR > 0.8:
#				if Lowest_DeltaR_jet == 0:
#					jDeta_4_nonHiggs = getDeltaEta(self,1,2)
#					mjj_AK4_qq = getMjj(self,1,2)
#                                if Lowest_DeltaR_jet == 1:
#                                        jDeta_4_nonHiggs = getDeltaEta(self,0,2)
#					mjj_AK4_qq = getMjj(self,0,2)
#				if Lowest_DeltaR_jet == 2 or Lowest_DeltaR_jet == 3:
#                                        jDeta_4_nonHiggs = getDeltaEta(self,0,1)
#					mjj_AK4_qq = getMjj(self,0,1)
#			else:
#				if (Lowest_DeltaR_jet == 0 and Lowest2nd_DeltaR_jet == 1) or (Lowest_DeltaR_jet == 1 and Lowest2nd_DeltaR_jet == 0):
#                                        jDeta_4_nonHiggs = getDeltaEta(self,2, 3)
#					mjj_AK4_qq = getMjj(self,2, 3)
#                                if (Lowest_DeltaR_jet == 0 and Lowest2nd_DeltaR_jet == 2) or (Lowest_DeltaR_jet == 2 and Lowest2nd_DeltaR_jet == 0):
#                                        jDeta_4_nonHiggs = getDeltaEta(self,1, 3)
#					mjj_AK4_qq = getMjj(self,1, 3)
#                                if (Lowest_DeltaR_jet == 0 and Lowest2nd_DeltaR_jet == 3) or (Lowest_DeltaR_jet == 3 and Lowest2nd_DeltaR_jet == 0):
#                                        jDeta_4_nonHiggs = getDeltaEta(self,1, 2)
#					mjj_AK4_qq = getMjj(self,1, 2)
#                                if (Lowest_DeltaR_jet == 1 and Lowest2nd_DeltaR_jet == 2) or (Lowest_DeltaR_jet == 2 and Lowest2nd_DeltaR_jet == 1):
#                                        jDeta_4_nonHiggs = getDeltaEta(self,0, 3)
#					mjj_AK4_qq = getMjj(self,0, 3)
#                                if (Lowest_DeltaR_jet == 1 and Lowest2nd_DeltaR_jet == 3) or (Lowest_DeltaR_jet == 3 and Lowest2nd_DeltaR_jet == 1):
#                                        jDeta_4_nonHiggs = getDeltaEta(self,0, 2)
#					mjj_AK4_qq = getMjj(self,0, 2)
#                                if (Lowest_DeltaR_jet == 2 and Lowest2nd_DeltaR_jet == 3) or (Lowest_DeltaR_jet == 3 and Lowest2nd_DeltaR_jet == 2):
#                                        jDeta_4_nonHiggs = getDeltaEta(self,0, 1)
#					mjj_AK4_qq = getMjj(self,0, 1)
...
#            elif DeltaR_2 > 0.8:
#                if DeltaR_3 > 0.8:
#                        jDeta_4_nonHiggs = abs(self.AK4Puppijet2_eta[0] - self.AK4Puppijet3_eta[0])
...
#                if jpt_8 > PTCUT and jpt_8 < 1000. and jdb_8 > DBTAGCUT and jmsd_8 > MASSCUT and jtN2b1sdddt_8 < 0 and rh_8<-2.1 and rh_8>-6. and nmuLoose == 0 and neleLoose == 0 and ntau == 0 and met < METCUT and mjj_AK4_qq < 200.:
		    ...
		    self.h_dEta_ak4_dbtagCut.Fill(jDeta_4, weight)
                    self.h_mjj_ak4.Fill(mjj_AK4, weight)
                    self.h_dEta_ak4_nonH_dbtagCut.Fill(jDeta_4_nonHiggs, weight)
		    self.h_met_dbtagCut.Fill(met,weight)
		    self.h_DeltaR_0.Fill(DeltaR_0,weight)
                    self.h_DeltaR_1.Fill(DeltaR_1,weight)
#                    self.h_msd_ak8_4ak4.Fill(nAK4PuppijetsPt30, weight)
                    self.h_mjj_ak4_qq.Fill(mjj_AK4_qq, weight)
                    self.h_mjj_ak4_qq_pT30.Fill(mjj_AK4_qq_pT30, weight)
                    self.h_mjj_ak4_qq_pT50.Fill(mjj_AK4_qq_pT50, weight)
                    self.h_mjj_ak4_qq_pT70.Fill(mjj_AK4_qq_pT70, weight)
                    self.h_mjj_ak4_qq_pT100.Fill(mjj_AK4_qq_pT100, weight)
                    self.h_dEta_ak4_nonH_dbtagCut_pT30.Fill(jDeta_ak4_pT30, weight)
